 ...
 */
public class DashboardAdapterFavoritos extends RecyclerView.Adapter<DashboardAdapterFavoritos.MyViewHolder> {
    ...
    public DashboardAdapterFavoritos(Context mContext, List<dashboard> dashboardList) {
