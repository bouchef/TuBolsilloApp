...
import static com.example.bouchef.tubolsillo.R.layout.activity_donde_estas_tutor;

public class DondeEstasTutor extends AppCompatActivity {
    private Context mContext= DondeEstasTutor.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(activity_donde_estas_tutor);
