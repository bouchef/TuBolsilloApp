...
public class ControlGastosRecyclerViewAdapter extends RecyclerView.Adapter<ControlGastosRecyclerViewAdapter.ViewHolder>
{
    ...
    public ControlGastosRecyclerViewAdapter(Context context, List<ItemBasico> emplazamientos) {
    ...
    @Override
    public ControlGastosRecyclerViewAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.gasto_item_list, parent, false);
        context = parent.getContext();
        return new ControlGastosRecyclerViewAdapter.ViewHolder(view);
    }

    // binds the data to the TextView in each row
    @Override
    public void onBindViewHolder(ControlGastosRecyclerViewAdapter.ViewHolder holder, final int position) {
        ...
        holder.text_precio.setText("$" + nf.format(c.getPrecio()));
...
/*
    ...
    public class ViewHolder extends RecyclerView.ViewHolder  {
        ...
        @BindView(R.id.text_precio) TextView text_precio;
