...
public class BookOrderActivityTutor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RecyclerView.LayoutManager layoutManager = new GridLayoutManager(BookOrderActivityTutor.this,2);
        ...
        bAdapter = new BookOrderAdapter(BookOrderActivityTutor.this,bookOrderModelClasses);
