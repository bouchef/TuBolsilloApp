...
import static com.example.bouchef.tubolsillo.R.layout.activity_inicio_pcd;

public class InicioPCD extends AppCompatActivity {

    private Context mContext= InicioPCD.this;
    ...
    private String lenguajeProgramacion[]=new String[]{"Alertar","Tu Lista de Compra","Negocios Amigables","Notificar","Estoy Aqui","Credencial"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(activity_inicio_pcd);
        ...
        OnItemClickListener itemClickListener = new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View container, int position, long id) {
                ...
                //Toast.makeText(InicioPCD.this.getBaseContext(), tvCountry.getText().toString(), 0).show();
                Toast toast1 =
                        Toast.makeText(InicioPCD.this.getBaseContext(), tvCountry.getText().toString(), Toast.LENGTH_SHORT);
