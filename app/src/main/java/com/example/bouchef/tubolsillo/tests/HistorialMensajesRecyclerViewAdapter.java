...
import com.example.bouchef.tubolsillo.HistorialTutor;
...
public class HistorialMensajesRecyclerViewAdapter extends RecyclerView.Adapter<HistorialMensajesRecyclerViewAdapter.ViewHolder>
{
    ...
    public HistorialMensajesRecyclerViewAdapter(Context context, List<ItemBasico> emplazamientos) {
    ...
    @Override
    public HistorialMensajesRecyclerViewAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.mensaje_item_list, parent, false);
        context = parent.getContext();
        return new HistorialMensajesRecyclerViewAdapter.ViewHolder(view);
    }

    // binds the data to the TextView in each row
    @Override
    public void onBindViewHolder(HistorialMensajesRecyclerViewAdapter.ViewHolder holder, final int position) {
